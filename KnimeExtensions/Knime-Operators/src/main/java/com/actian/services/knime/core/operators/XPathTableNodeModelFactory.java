...
public class XPathTableNodeModelFactory extends AbstractDRNodeFactory<XPathTable> {

	@Override
	protected DRNodeModel<XPathTable> createDRNodeModel() {
		return new DRNodeModel<XPathTable>( new XPathTable(), new XPathTableNodeSettings());
	}

	@Override
	protected CustomDRNodeDialogPane<XPathTable> createNodeDialogPane() {
		CustomDRNodeDialogPane<XPathTable> dialog = new CustomDRNodeDialogPane<XPathTable>(new XPathTable(), new XPathTableNodeDialogPane());
